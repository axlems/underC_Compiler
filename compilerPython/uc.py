...
# Defined types as strings inside sets
dataTypes = { 
	'I64', 'I32', 'I16', 'I8', 'U64', 'U32', 'U16', 'U8', 'F64', 'F32', 'F16', 'F8', 'B1', 
	'@I64', '@I32', '@I16', '@I8', '@U64', '@U32', '@U16', '@U8', '@F64', '@F32', '@B1', 
	'*I64', '*I32', '*I16', '*I8', '*U64', '*U32', '*U16', '*U8', '*F64', '*F32', '*F16', '*B1', 
	'*@I64', '*@I32', '*@I16', '*@I8', '*@U64', '*@U32', '*@U16', '*@U8', '*@F64', '*@F32', '*@B1', 
	'@*I64', '@*I32', '@*I16', '@*I8', '@*U64', '@*U32', '@*U8', '@*F64', '@*F32', '@*B1' 
}
...
keywords = { 'return', '#include', 'if', 'elif', 'else', 'true', 'false' }

# Defined the correct string prefix expected at the CLI
abcs = "uc"
